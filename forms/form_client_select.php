              ...
              <div class="card">
                <div class="card-body">
                  <div class="d-flex flex-column align-items-center text-center">
                    <img src="../images/perfils/<?php echo $c[($_SESSION['cliente_id'])-1]['foto']; ?>" class="rounded-circle" width="150">
                    <div class="mt-3">
                ...
                <div class="card-body">
                  <div class="row">
                    ...
                    <div class="col-sm-9 text-secondary">
                      <?php echo $c[($_SESSION['cliente_id'])-1]['nombre']." ".$c[($_SESSION['cliente_id'])-1]['apellido'] ?>
                    </div>
                  </div>
                  <hr>
                  <div class="row">
                    ...
                    <div class="col-sm-9 text-secondary">
                      <?php echo $c[($_SESSION['cliente_id'])-1]['email'] ?>
                    </div>
                  </div>
                  <hr>
                  <div class="row">
                    ...
                    <div class="col-sm-9 text-secondary">
                    <?php echo $c[($_SESSION['cliente_id'])-1]['tlf'] ?>
                    </div>
                  </div>
                  <hr>
                  <div class="row">
                    ...
                    <div class="col-sm-9 text-secondary">
                      <?php echo $c[($_SESSION['cliente_id'])-1]['dni'] ?>
                    </div>
                  </div>
                  <hr>
                  <div class="row">
                    ...
                    <div class="col-sm-9 text-secondary">
                      <?php echo $c[($_SESSION['cliente_id'])-1]['direccion'] ?>
                    </div>
                  </div>
                  <hr>
                  <div class="row">
