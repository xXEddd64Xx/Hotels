              ...
              <div class="card">
                <div class="card-body">
                  <div class="d-flex flex-column align-items-center text-center">
                    <img src="../images/perfils/<?php echo $c[0]['foto'];?> alt="Admin" class="rounded-circle" width="150">
                    <div class="mt-3">
                      ...
                      <form action="pujar.php" method="post" enctype="multipart/form-data">
                          <button class="btn btn-primary" type="file" name="foto">Editar Foto</button>
                          </br>
                ...
                <div class="card-body">
                  <div class="row">
                    ...
                    <div class="col-sm-9 text-secondary">
                      <?php echo $c[0]['nombre']." ".$c[0]['apellido'] ?>
                    </div>
                  </div>
                  <hr>
                  <div class="row">
